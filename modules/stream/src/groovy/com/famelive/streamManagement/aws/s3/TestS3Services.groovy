package com.famelive.streamManagement.aws.s3
...
public class TestS3Services {
    ...
    public String createFolders(String folderPath) {
        ...
        AmazonS3 s3 = new AmazonS3Client(credentials);
        String bucketName = grailsApplication.config.famelive.aws.bucketName
        String key = (folderPath + File.separator + fileName).toString()
        CannedAccessControlList acl = CannedAccessControlList.BucketOwnerRead
        ObjectMetadata metadata = new ObjectMetadata()
        metadata.setContentType("html/text")
        s3.putObject(new PutObjectRequest(bucketName, key, FameLiveUtil.fetchInputStreamFromString("test file"), metadata));
        s3.setObjectAcl(bucketName, key, acl)
        return 'file added at ' + folderPath
    }
