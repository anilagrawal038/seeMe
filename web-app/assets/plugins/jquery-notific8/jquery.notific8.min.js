 ...
 */
!function (t) {
    var i = {life: 1e4, theme: "teal", sticky: !1, verticalEdge: "right", horizontalEdge: "top", zindex: 1100}, e = {
        init: function (n, a) {
            return this.each(function () {
                ...
                o.data("notific8", {
                    ...
                    settings: {},
                    message: ""
                }), d = o.data("notific8"), d.message = n, t.extend(d.settings, i, a), e._buildNotification(o)
            })
        }, destroy: function (i) {
            ...
            n.append(t("<div />").addClass("jquery-notific8-message").html(e.message)), t(".jquery-notific8-container." + e.settings.verticalEdge + "." + e.settings.horizontalEdge).append(n), n.animate({width: "show"}, {
                duration: "fast", complete: function () {
                    e.settings.sticky || !function (t, i) {
                        setTimeout(function () {
                            t.animate({width: "hide"}, {
                                duration: "fast", complete: function () {
                                    t.remove()
                                }
                            })
