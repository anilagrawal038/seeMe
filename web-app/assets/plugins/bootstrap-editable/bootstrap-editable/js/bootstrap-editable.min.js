...
!function (t) {
    ...
    e.prototype = {
        constructor: e, initInput: function () {
            ...
            var t, e;
            this.$form ? (t = this.$form.outerWidth(), e = this.$form.outerHeight(), t
            &&
            this.$loading.width(t), e && this.$loading.height(e), this.$form.hide()
            ) :
            (t = this.$loading.parent().width(), t
            &&
            this.$loading.width(t)
            ),
            this.$loading.show()
        }, showForm: function (t) {
    ...
    e.prototype = {
        ...
        switch (i) {
            ...
            case"submit":
                ...
                return t.isEmptyObject(c) ? (s = this.editable("getValue"), a
            .
                data && t.extend(s, a.data), t.ajax(t.extend({
                    url: a.url,
                    data: s,
                    type: "POST"
        ...
        return this.each(function () {
            ...
            return a && a.selector ? (s = new e(this, a), void 0
            ) :
            (s || n.data(r, s = new e(this, a)), "string" == typeof i && s[i].apply(s, Array.prototype.slice.call(o, 1)), void 0)
        })
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        render: function () {
            ...
            var n;
            if (t.isFunction(this.options.source) ? (n = this.options.source.call(this.options.scope), this.sourceData = null) :
            n = this.options.source, this.options.sourceCache && t.isArray(this.sourceData)
            )
            ...
            if (t.isArray(e)) {
                ...
                for (var a = 0; a < e.length; a++)o = e[a], "object" == typeof o ? (i = 0, t
            .
                each(o, r), 1 === i ? s.push(n) : i > 1 && (o.children && (o.children = this.makeArray(o.children)), s.push(o))
            ) :
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        render: function () {
            ...
            var n, o = "", r = this;
            this.options.select2.tags ? n = e : this.sourceData && (n = t.fn.editableutils.itemsByValue(e, this.sourceData, this.idFunc)), t.isArray(n) ? (o = [], t
            .
            each(n, function (t, e) {
    ...
    e.prototype = {
        constructor: e, init: function () {
            ...
            return t.each(this.map, function (t) {
                if ("ampm" !== t) {
                    var e = "day" === t ? 1 : 0;
                    return n[t] = o["$" + t] ? parseInt(o["$" + t].val(), 10) : e, isNaN(n[t]) ? (r = !0, !1
                ) :
                    void 0
                }
    ...
    o.prototype = {
        constructor: o, _process_options: function (e) {
            ...
            if (this._allow_update) {
                var t, e = !1;
                arguments && arguments.length && ("string" == typeof arguments[0] || arguments[0]instanceof Date) ? (t = arguments[0], e = !0): (t = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val(),
                delete this.element.data().date
            ),
                this.date = d.parseDate(t, this.o.format, this.o.language), e && this.setValue(), this.viewDate = this.date < this.o.startDate ? new Date(this.o.startDate) : this.date > this.o.endDate ? new Date(this.o.endDate) : new Date(this.date), this.fill()
            }
        }, fillDow: function () {
            ...
            if (1 == n.length)switch (n[0].nodeName.toLowerCase()) {
                ...
                case"td":
                    if (n.is(".day") && !n.is(".disabled")) {
                        ...
                        n.is(".old") ? 0 === c ? (c = 11, h -= 1
                    ) :
                        c -= 1
                    :
                        n.is(".new") && (11 == c ? (c = 0, h += 1)
                    :
                        c += 1
                    ),
            ...
            switch (t.keyCode) {
                ...
                case 39:
                    ...
                    e = 37 == t.keyCode ? -1 : 1, t.ctrlKey ? (i = this.moveYear(this.date, e), n = this.moveYear(this.viewDate, e)):t.shiftKey ? (i = this.moveMonth(this.date, e), n = this.moveMonth(this.viewDate, e)): (i = new Date(this.date), i
                .
                    setUTCDate(this.date.getUTCDate() + e), n = new Date(this.viewDate), n.setUTCDate(this.viewDate.getUTCDate() + e)
                ),
                    this.dateWithinRange(i) && (this.date = i, this.viewDate = n, this.setValue(), this.update(), t.preventDefault(), o = !0);
                    break;
                case 38:
                case 40:
                    if (!this.o.keyboardNavigation)break;
                    e = 38 == t.keyCode ? -1 : 1, t.ctrlKey ? (i = this.moveYear(this.date, e), n = this.moveYear(this.viewDate, e)):t.shiftKey ? (i = this.moveMonth(this.date, e), n = this.moveMonth(this.viewDate, e)): (i = new Date(this.date), i
                .
                    setUTCDate(this.date.getUTCDate() + 7 * e), n = new Date(this.viewDate), n.setUTCDate(this.viewDate.getUTCDate() + 7 * e)
                ),
                    this.dateWithinRange(i) && (this.date = i, this.viewDate = n, this.setValue(), this.update(), t.preventDefault(), o = !0);
                    break;
                case 13:
