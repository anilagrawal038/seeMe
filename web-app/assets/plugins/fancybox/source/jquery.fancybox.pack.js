...
(function (B, x, f, q) {
    ...
    f.extend(b, {
        ...
        _setDimension: function () {
            ...
            (i = t, c = k(i * D))) : (c = Math.max(l, Math.min(c, m)), h
            .
            autoHeight && "iframe" !== h.type && (g.width(c), i = g.height()), i = Math.max(t, Math.min(i, n))
            )
            ;
    ...
    b.transitions = {
        getOrigPosition: function () {
            ...
            s(e) ? (c = e.offset(),
                    e
            .
            is("img") && (f = e.outerWidth(), g = e.outerHeight())
            ) :
            ...
            delete j.position;
            c ? (d = this.getOrigPosition(), a
            .
            openOpacity && (d.opacity = 0.1)
            ) :
    ...
    b.helpers.overlay = {
        ...
        update: function () {
            ...
            f.browser.msie ? (b = Math.max(x.documentElement.offsetWidth, x.body.offsetWidth), m
            .
            width() > b && (a = m.width())
            ) :
