!function (e, t) {
    ...
    var t = function (e, t) {
        ...
        var e = document, o = function (n) {
            ...
            var r, s = this, l = ["bounds_changed", "center_changed", "click", "dblclick", "drag", "dragend", "dragstart", "idle", "maptypeid_changed", "projection_changed", "resize", "tilesloaded", "zoom_changed"], p = ["mousemove", "mouseout", "mouseover"], g = ["el", "lat", "lng", "mapType", "width", "height", "markerClusterer", "enableNewStyle"], c = n.el || n.div, h = n.markerClusterer, u = google.maps.MapTypeId[n.mapType.toUpperCase()], d = new google.maps.LatLng(n.lat, n.lng), f = n.zoomControl || !0, m = n.zoomControlOpt || {
                    style: "DEFAULT",
                    position: "TOP_LEFT"
                }, y = m.style || "DEFAULT", v = m.position || "TOP_LEFT", k = n.panControl || !0, w = n.mapTypeControl || !0, b = n.scaleControl || !0, L = n.streetViewControl || !0, _ = _ || !0, M = {}, x = {
                zoom: this.zoom,
                center: d,
                mapTypeId: u
            }, P = {
            ...
            var O = function (e, t) {
                ...
                if (i("gmaps_context_menu")) {
                    ...
                    p.innerHTML = o;
                    var g = p.getElementsByTagName("a"), c = g.length;
                    for (r = 0; c > r; r++) {
    ...
    l.prototype.createControl = function (e) {
        ...
        var o = this, n = e.details, r = e.fences, s = e.outside, i = {
            position: new google.maps.LatLng(e.lat, e.lng),
            map: null
        };
        delete e.lat, delete e.lng, delete e.fences, delete e.outside;
        var a = t(i, e), l = new google.maps.Marker(a);
    ...
    return l.prototype.getRoutes = function (e) {
        ...
        if (s)for (var h, u, d = 0; o = s[d]; d++) {
            ...
            h.length || 0 === d ? (h.push(u), h = h.join("|"), n.push("markers=" + encodeURI(h))) : (h = n.pop() + encodeURI("|" + u), n
        .
            push(h)
        )
        }
        ...
        if (a) {
            ...
            var L = o.path;
            if (L.join)for (var _, m = 0; _ = L[m]; m++)a.push(_.join(",")); else a.push("enc:" + L);
