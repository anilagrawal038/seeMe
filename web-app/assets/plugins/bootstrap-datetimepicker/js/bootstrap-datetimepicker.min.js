    ...
    i.prototype = {
        constructor: i, _events: [], _attachEvents: function () {
            ...
            if (!this.isInline) {
                ...
                this.component ? (e = this.component.offset(), n = e.left, ("bottom-left" == this.pickerPosition || "top-left" == this.pickerPosition) && (n += this.component.outerWidth() - this.picker.outerWidth())
            ) :
                (e = this.element.offset(), n = e.left), i = "top-left" == this.pickerPosition || "top-right" == this.pickerPosition ? e.top - this.picker.outerHeight() : e.top + this.height, this.picker.css({
                    top: i,
                    left: n,
                    zIndex: s
                })
            ...
            if (null != this.date && null != this.viewDate) {
                ...
                for (var k = "", _ = "", $ = "", D = 0; 24 > D; D++) {
                    var I = e(a, o, r, D);
                    C = "", I.valueOf() + 36e5 <= this.startDate || I.valueOf() > this.endDate ? C += " disabled" : l == D && (C += " active"), this.showMeridian && 2 == n[this.language].meridiem.length ? (_ = 12 > D ? n[this.language].meridiem[0] : n[this.language].meridiem[1], _
                !=
                    $ && ("" != $ && S.push("</fieldset>"), S.push('<fieldset class="hour"><legend>' + _.toUpperCase() + "</legend>")), $ = _, k = D % 12 ? D % 12 : 12, S.push('<span class="hour' + C + " hour_" + (12 > D ? "am" : "pm") + '">' + k + "</span>"), 23 == D && S.push("</fieldset>")
                ) :
                    (k = D + ":00", S
                .
                    push('<span class="hour' + C + '">' + k + "</span>")
                )
                }
                this.picker.find(".datetimepicker-hours td").html(S.join("")), S = [], k = "", _ = "", $ = "";
                for (var D = 0; 60 > D; D += this.minuteStep) {
                    var I = e(a, o, r, l, D, 0);
                    C = "", I.valueOf() < this.startDate || I.valueOf() > this.endDate ? C += " disabled" : Math.floor(c / this.minuteStep) == Math.floor(D / this.minuteStep) && (C += " active"), this.showMeridian && 2 == n[this.language].meridiem.length ? (_ = 12 > l ? n[this.language].meridiem[0] : n[this.language].meridiem[1], _
                !=
                    $ && ("" != $ && S.push("</fieldset>"), S.push('<fieldset class="minute"><legend>' + _.toUpperCase() + "</legend>")), $ = _, k = l % 12 ? l % 12 : 12, S.push('<span class="minute' + C + '">' + k + ":" + (10 > D ? "0" + D : D) + "</span>"), 59 == D && S.push("</fieldset>")
                ) :
                    (k = D + ":00", S
                .
                    push('<span class="minute' + C + '">' + l + ":" + (10 > D ? "0" + D : D) + "</span>")
                )
                }
                ...
                switch (n[0].nodeName.toLowerCase()) {
                    ...
                    case"span":
                        if (!n.is(".disabled")) {
                            ...
                            n.is(".minute") && (h = parseInt(n.text().substr(n.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(h), this.element.trigger({
                                type: "changeMinute",
                                date: this.viewDate
                    ...
                    case"td":
                        if (n.is(".day") && !n.is(".disabled")) {
                            ...
                            n.is(".old") ? 0 === l ? (l = 11, r -= 1
                        ) :
                            l -= 1
                        :
                            n.is(".new") && (11 == l ? (l = 0, r += 1)
                        :
                            l += 1
                        ),
                            this.viewDate.setUTCFullYear(r), this.viewDate.setUTCMonth(l), this.viewDate.setUTCDate(c), this.element.trigger({
                                type: "changeDay",
                                date: this.viewDate
