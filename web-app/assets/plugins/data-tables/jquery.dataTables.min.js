    ...
    var L = function (h) {
        var j = function (e) {
                ...
                for (var c = a.nTableWrapper, d = a.sDom.split(""), i, f, g, e, w, o, k, m = 0; m < d.length; m++) {
                    ...
                    if ("<" == g) {
                        ...
                        if ("'" == w || '"' == w) {
                            ...
                            -1 != o.indexOf(".") ? (w = o.split("."), e
                        .
                            id = w[0].substr(1, w[0].length - 1), e.className = w[1]
                        ) :
                            "#" == o.charAt(0) ? e.id = o.substr(1, o.length - 1) : e.className = o;
                            m += k
                        }
                        c.appendChild(e);
                        c = e
                ...
                Ra(b, {}, function (b) {
                    if (!1 !== a.aoColumns[c].bSortable) {
                        var e = function () {
                            ...
                            } else 1 == a.aaSorting.length && a.aaSorting[0][0] == c ? (d = a.aaSorting[0][0], e = a.aaSorting[0][2] + 1, a
                            .
                            aoColumns[d].asSorting[e] || (e = 0), a.aaSorting[0][1] = a.aoColumns[d].asSorting[e], a.aaSorting[0][2] = e
                            ) :
            ...
            this.fnGetPosition = function (a) {
                ...
                return "TR" == c ? I(b, a) : "TD" == c || "TH" == c ? (c = I(b, a.parentNode), a = fa(b, c, a), [c, R(b, a), a
                ]) :
                null
            };
            ...
            two_button: {
                ...
                fnUpdate: function (e, o) {
                    if (e.aanFeatures.p) {
                        ...
                        -1 === e._iDisplayLength ? n = k = r = 1 : l < m ? (r = 1, k = l):n
                    <=
                        k ? (r = 1, k = m):n
                    >=
                        l - k ? (r = l - m + 1, k = l): (r = n - Math.ceil(m / 2) + 1, k = r + m - 1);
                        for (m = r; m <= k; m++)t +=
