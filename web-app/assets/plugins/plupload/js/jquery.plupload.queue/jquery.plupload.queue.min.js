...
(function (e) {
    ...
    e.fn.pluploadQueue = function (i) {
        return i ? (this.each(function () {
            ...
            var s, o, u, a;
            o = e(this), u = o.attr("id"), u || (u = plupload.guid(), o.attr("id", u)), a = o.html(), r(u, o), i = e.extend({
                dragdrop: !0,
                browse_button: u + "_browse",
                container: u
            }, i), i.dragdrop && (i.drop_element = u + "_filelist"), s = new plupload.Uploader(i), t[u] = s, s.bind("UploadFile", function (t, n) {
                ...
                }), e("#" + u + "_container").attr("title", "Using runtime: " + n.runtime), e("a.plupload_start", o).click(function (t) {
            ...
            }), s.bind("FilesAdded", c), s.bind("FilesRemoved", function () {
