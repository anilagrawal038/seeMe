...
// convert plupload features to caps acceptable by mOxie
    ...
    var plupload = {
        ...
        /**
         * Generic I/O error. For exampe if it wasn't possible to open the file streamManagement on local machine.
         *
         * @property IO_ERROR
         * @static
         * @final
        ...
        function onUploadFile(up, file) {
            ...
            function uploadNextChunk() {
                ...
                if (up.settings.multipart && features.multipart) {
                    ...
                    // if no multipart, send as binary streamManagement
                    url = plupload.buildUrl(up.settings.url, plupload.extend(args, up.settings.multipart_params));

                    xhr.open("post", url, true);

                    xhr.setRequestHeader('Content-Type', 'application/octet-streamManagement'); // Binary streamManagement header
